...
export const pillTabVariants = cva(
  'inline-flex items-center justify-center rounded-full px-4 py-2.5 text-xs font-semibold whitespace-nowrap shrink-0 gap-2 transition-colors duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-2',
  {
    variants: {
      state: {
