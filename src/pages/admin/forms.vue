<script setup lang="ts">
  ...
  definePage({
    meta: {
      // Custom breadcrumbs with custom navigation
      breadcrumbs: [
        { label: 'Dashboard', to: '/admin/overview' },
        { label: 'Components', to: '/admin' },
        { label: 'Form Components' },
        { label: 'Form Components 1' },
        { label: 'Form Components 2' },
      ],
    },
  })
  ...
  // Simulate edit mode with existing images (URLs from server)
  ...
  // Form initialization with vee-validate
...
<template>
  <div class="max-w-4xl space-y-6">
    ...
    <Card>
      ...
      <CardContent>
        <form @submit="onSubmit" class="space-y-6">
          ...
          <!-- Format Demo Section - Prefix/Suffix Examples -->
          <div class="space-y-4">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              ...
              <!-- Discount with Percentage Format -->
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3">
              <!-- Ticket Quantity with "tiket" Format -->
              ...
              <!-- Product Quantity with "pcs" Format -->
              ...
              <!-- Unit Quantity with "unit" Format -->
          ...
          <!-- Dropdown/Combobox Section -->
          <div class="space-y-4">
            <h3 class="body-l-medium text-foreground">Dropdown Components</h3>

            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
              <!-- Country - SearchableSelectField with description -->
              ...
              <!-- Status - SearchableSelectField with badge -->
            ...
            <!-- Department - SearchableSelectField with groups -->
            ...
            <!-- Skills - MultiSelectField with badges -->
            ...
            <!-- Tags - TagInputField for free text input -->
            ...
            <!-- Priority - SelectOptionField with flat options -->
            ...
            <!-- Category - SelectOptionField with grouped options -->
          ...
          <div class="space-y-4">
            ...
            <!-- Single Image Upload with AlertBox (using props) -->
            <ImageUploaderField
              v-model="singleImage"
            ...
            <!-- Multiple Image Upload with AlertBox (using slot) -->
            <ImageUploaderField
    ...
    <!-- Form Data Preview Card (for development) -->
